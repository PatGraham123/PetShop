...
namespace PetShop {
    ...
    public partial class CartDataSet : global::System.Data.DataSet {
        ...
        public partial class CartDataTable : global::System.Data.TypedTableBase<CartRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CartRow AddCartRow(int Id, string Name, string Type, decimal Cost, int Qty) {
        ...
        public partial class CartRow : global::System.Data.DataRow {
            ...
            public decimal Cost {
                get {
                    return ((decimal)(this[this.tableCart.CostColumn]));
                }
                set {
                    this[this.tableCart.CostColumn] = value;
                }
            }
    ...
    public partial class CartTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cart] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Nam" +
                "e) AND ([Type] = @Original_Type) AND ([Cost] = @Original_Cost) AND ([Qty] = @Ori" +
                "ginal_Qty))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cart] ([Id], [Name], [Type], [Cost], [Qty]) VALUES (@Id, @Name" +
                ", @Type, @Cost, @Qty);\r\nSELECT Id, Name, Type, Cost, Qty FROM Cart WHERE (Id = @" +
                "Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cart] SET [Id] = @Id, [Name] = @Name, [Type] = @Type, [Cost] = @Cost, [Qty] = @Qty WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Type] = @Original_Type) AND ([Cost] = @Original_Cost) AND ([Qty] = @Original_Qty));
SELECT Id, Name, Type, Cost, Qty FROM Cart WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Type, Cost, Qty FROM dbo.Cart";
        ...
        public virtual int Fill(CartDataSet.CartDataTable dataTable) {
        ...
        public virtual CartDataSet.CartDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CartDataSet.CartDataTable dataTable = new CartDataSet.CartDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CartDataSet.CartDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Type, decimal Original_Cost, int Original_Qty) {
        ...
        public virtual int Insert(int Id, string Name, string Type, decimal Cost, int Qty) {
        ...
        public virtual int Update(int Id, string Name, string Type, decimal Cost, int Qty, int Original_Id, string Original_Name, string Original_Type, decimal Original_Cost, int Original_Qty) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Type, decimal Cost, int Qty, int Original_Id, string Original_Name, string Original_Type, decimal Original_Cost, int Original_Qty) {
